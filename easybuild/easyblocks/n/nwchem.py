...
class EB_NWChem(ConfigureMake):
    ...
    def configure_step(self):
        ...
        # for NWChem 6.6 and newer, $LIBMPI & co should not longer be set
        # the correct values are determined by the NWChem build procedure automatically
        # see http://www.nwchem-sw.org/index.php/Compiling_NWChem#MPI_variables
        if LooseVersion(self.version) <= LooseVersion('6.5'):
